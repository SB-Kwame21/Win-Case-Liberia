...
function LawfirmSignIn({ navigation }) {
    ...
    return (
        ...
        >
            ...
            <View style={styles.option}>
                <TouchableOpacity>
                    <Text style={styles.optionText} onPress={() => navigation.navigate('LawfirmSignUp')}>Create Account</Text>
                </TouchableOpacity>
