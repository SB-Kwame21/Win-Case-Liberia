...
import AttorneyAppointmentsScreen from '../screens/AttorneyAppointmentsScreen';
...
const MainDrawer = () => {
    ...
    >
     ...
     <Drawer.Screen name="Booked" component={Booked}
            ...
            <Drawer.Screen name="Our Services" component={OurServicesScreen}
             options={{
                drawerIcon:({color, size}) => (
...
const LawyerMainDrawer = () => {
    ...
    >
        ...
        <Drawer.Screen name="Appointments" component={AttorneyAppointmentsScreen}
                options={{
                    drawerIcon: ({ color, size }) => (
                        <MaterialCommunityIcons name="checkbox-multiple-marked" size={20} color={Color.primary}/>
                    ),
